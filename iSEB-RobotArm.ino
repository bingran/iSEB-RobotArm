...
void handleIndex() {
  ...
  content += "</style>";
  content += "</head>";
  content += "<body><h1><p><b>SMLab™ iRobotArm</b></p></h1>";
  content += "<table width=100% height=25%>";
  content += "<tr>";
  content += "<td width=33%><button class=\"button button2\" onclick=controlPm(1)><p><b>Action1</b></p></button></td>";
  content += "<td width=33%><button class=\"button\" onclick=controlPm(2)><p><b>Action2</b></p></button></td>";
  content += "<td width=33%><button class=\"button button3\" onclick=controlPm(3)><p><b>Action3</b></p></button></td>";
  content += "</tr>";
  content += "</table>";
  content += "<table width=100% height=45%>";
  content += "<tr><td colspan=4><span><br></span></td></tr>";
  content += "<tr>";
  content += "<td width=33%><button class=\"button7 button4\" onclick=controlServo(0,'range_0',1)>Clockwise</button></td>";
  ...
  content += "<td width=33%><button class=\"button7 button5\"  onclick=controlServo(0,'range_0',2)>AntiCLockise</button></td>";
  content += "</tr>";
  content += "<tr><td colspan=4><span><br></span></td></tr>";
  content += "<tr>";
  content += "<td width=33%><button class=\"button7 button4\"  onclick=controlServo(1,'range_1',1)>Clockwise</button></td>";
  content += "<td width=33%>Shoulder <span><br>0 <input type=range id=range_1 min=0 max=180 value=90 onchange=controlServo(1,'range_1',0)> 180</span>";
    content += "<td width=33%><button class=\"button7 button5\"  onclick=controlServo(1,'range_1',2)>AntiCLockise</button></td>";
  content += "</tr>";
  content += "<tr><td colspan=4><span><br></span></td></tr>";
  content += "<tr>";
  content += "<td width=33%><button class=\"button7 button4\"  onclick=controlServo(2,'range_2',1)>Clockwise</button></td>";
  content += "<td width=33%>Base <span><br>0 <input type=range id=range_2 min=0 max=180 value=90 onchange=controlServo(2,'range_2',0)> 180</span>";
    content += "<td width=33%><button class=\"button7 button5\"  onclick=controlServo(2,'range_2',2)>AntiCLockise</button></td>";
  content += "</tr>";
  content += "<tr><td colspan=4><span><br></span></td></tr>";
  content += "<tr>";
  content += "<td width=33%><button class=\"button7 button4\" onclick=controlServo(3,'range_3',1)>Clockwise</button></td>";
  ...
  content += "<td width=33%><button class=\"button7 button5\" onclick=controlServo(3,'range_3',2)>AntiCLockise</button></td>";
  content += "</tr>";
  content += "</table>";
  content += "</body>";
  content += "<script>";  
